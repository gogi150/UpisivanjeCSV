...
namespace zadatak_WF
{
    public partial class Form1 : Form
    {
        ...
        private void btnUpis_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Osoba osoba = new Osoba(txtIme.Text, txtPrezime.Text, txtEmail.Text,
                    Convert.ToInt16(txtGodinaRođenja.Text));
                    ...
                    case DialogResult.No:
                        {
                            ...
                            txtGodinaRođenja.Enabled = false;
